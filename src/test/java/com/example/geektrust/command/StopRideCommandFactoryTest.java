...
class StopRideCommandFactoryTest {
  ...
  @Test
  void createsStopRideCommand() {
    StopRideCommandFactory factory = new StopRideCommandFactory(rideService());
    ParsedInput input = new ParsedInput("STOP_RIDE", "ride-1", Arrays.asList("1", "2", "3"));
  ...
  void missingArgsThrows() {
    StopRideCommandFactory factory = new StopRideCommandFactory(rideService());
    ParsedInput input = new ParsedInput("STOP_RIDE", "ride-1", Arrays.asList("1", "2"));
